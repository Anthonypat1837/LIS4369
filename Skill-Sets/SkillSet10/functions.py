def get_requirements():
    print("Developer: Anthony Patregnani")
    print("Python Sets Dictionaries")
    print("\nProgram Requirements:\n"
        ...
        + "\tUse the following keys: fname, lname, degree, major, pga\n"
...
def using_dictionaries():
    ...
    print("\nReturn view of object of all values in dictionary, built-in function: ")
    ...
    print("\nCount the number of items(key: value pairs) in dictionary: ")
